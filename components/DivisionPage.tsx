...
export function DivisionPage({data}:{data:DivisionPageData}){const contactHref=data.theme==="print"?"/?service=print-hub#contact":"/#contact";return <main className={`division-page theme-${data.theme}`}><Navbar/>
